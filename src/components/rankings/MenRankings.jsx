...
const MenRankings = () => {
  console.log(MensTeamList, MensBattingList);
  return (
    <div className="py-12 w-full flex flex-col gap-12">
      ...
      {/* Mens batting rankings */}
      <div>
        <h1 className="pb-4 border-b border-gray-200 w-full font-bold text-xl">
          Men&apos;s Batting Ranking
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          {MensBattingList?.map((ranking) => (
            <div
              key={ranking.value}
              className="bg-white py-3 rounded-lg shadow-md border border-gray-200"
            >
      ...
      {/* Mens allrounding rating */}
      <div>
        <h1 className="pb-4 border-b border-gray-200 w-full font-bold text-xl">
          Men&apos;s All-Rounders Ranking
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          {MensAllRounderList?.map((ranking) => (
            <div
              key={ranking.value}
              className="bg-white py-3 rounded-lg shadow-md border border-gray-200"
            >
