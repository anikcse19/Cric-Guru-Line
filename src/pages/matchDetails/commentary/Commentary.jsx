...
const Commentary = () => {
  ...
  return (
    <div>
      {!commentaryData?.score?.str &&
      !commentaryData?.score?.n_str &&
      !commentaryData?.balls ? (
        ...
        <>
                    ...
                    <tr className="bg-gray-50">
                      <td className="py-3 px-2">
                        ...
                        <p className="mt-2">
                          ...
                          <br />
                          {lastWicket?.r}({lastWicket?.b}) - {lastWicket?.sc} in{" "}
                          {lastWicket?.ov} ov
                        </p>
                        <p className="mt-2">
          ...
          <div>
            {commentaryData?.score?.rl && (
              <div>
                <p className="text-red-500 text-xl font-semibold">
                  {commentaryData?.score?.rl?.msg}{" "}
                </p>
                {commentaryData?.score?.mom && (
                  <div className=" bg-[#f3f5f8] flex my-8  h-28 items-center gap-12">
                    <div
                    ...
                    <div>
                      <h2 className=" text-sm font-semibold mb-2">Player of the Match</h2>
                      <div className=" flex items-center">
                        <img
                          src={`${imageUrl}/players/${commentaryData?.score?.mom?.l}`}
                          alt=""
                          className=" w-16 h-16"
                        />
                        <h2 className="text-lg text-blue-500 font-semibold">{commentaryData?.score?.mom?.n}</h2>
                      </div>
                    </div>
                  </div>
                )}
                      ...
                      <div className="p-2 w-full justify-between border-t flex text-sm">
                        ...
                        <div className=" border-l w-1/2 text-lg font-medium p-3">
                          <div className=" flex w-full justify-between mb-3">
                            ...
                            <p className=" w-1/2">
                              {" "}
                              {item?.ovsum?.bt?.b1?.r}({item?.ovsum?.bt?.b1?.b})
                            </p>
                          </div>
                          <div className=" flex w-full justify-between items-start mb-3">
                            ...
                            <p className=" w-1/2 text-start">
                              {" "}
                              {item?.ovsum?.bt?.b2?.r}({item?.ovsum?.bt?.b2?.b})
                            </p>
                          </div>
                          <div className=" flex w-full justify-between mb-3">
