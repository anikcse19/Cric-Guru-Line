...
const recentTabs = [
  { name: "ALL", path: "/cricket-schedule/recent/all" },
  { name: "T-20", path: "/cricket-schedule/recent/t20" },
  { name: "ODI", path: "/cricket-schedule/recent/odi" },
  { name: "TEST", path: "/cricket-schedule/recent/test" },
  { name: "T-10", path: "/cricket-schedule/recent/t10" },
];
